...
public void setup() {
  ...
  for (int i = 0; i < AMOUNT; i++) {
    x[i] = PApplet.parseInt(random(-6400, 6400));
    y[i] = PApplet.parseInt(random(-6400, 6400));
    z[i] = PApplet.parseInt(random(-6400, 6400));
  }
}
...
public void draw() {
  ...
  rotateY(frameCount / 1000.0f);
  rotateX(frameCount / -5000.0f);
